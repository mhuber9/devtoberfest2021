...
function buildDestinationHttpRequestConfig(destination, headers) {
    return __assign({ baseURL: destination.url, headers: headers, params: destination.queryParameters }, http_agent_1.getAgentConfig(destination));
}
...
function getCsrfHeaders(destination, request) {
    return __awaiter(this, void 0, void 0, function () {
        var csrfHeaders;
        return __generator(this, function (_a) {
            csrfHeaders = util_1.pickIgnoreCase(request.headers, 'x-csrf-token');
